				...
				<div class="single-post">
                    <div class="post-header mb-5 ">
                        <div class="meta-cat text-color">
                            ...
                            <a class="post-category font-extra text-color text-uppercase font-sm letter-spacing-1" href="<?=base_url("/Artikel");?>">E-Artikel</a>
                        </div>
                    </div>
                    <div class="post-body">
                        ...
                        <?php
                            foreach($article as $value):
                                echo "<div class=\"media sidebar-post-items\">
                                            ...
                                            <div class=\"media-body\">
                                                ...
                                                <h4><a href=\"".base_url('Berita/'.$value['slug'])."\">".$value['title']."</a></h4>
                                            </div>
                                        </div>";
                            endforeach;
                        ?>
